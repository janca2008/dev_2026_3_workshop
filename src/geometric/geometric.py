class Geometria:
    ...
    def area_pentagono_regular(self, lado, apotema):
        ...
        """
        return 0.5 * self.perimetro_pentagono_regular(lado) * apotema
    ...
    def area_hexagono_regular(self, lado, apotema):
        ...
        """
        return 0.5 * self.perimetro_hexagono_regular(lado) * apotema
    ...
    def area_poligono_regular(self, num_lados, lado, apotema):
        ...
        """
        return 0.5 * self.perimetro_poligono_regular(num_lados, lado) * apotema
